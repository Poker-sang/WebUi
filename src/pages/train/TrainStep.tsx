...
const TrainStep: React.FC<unknown> = () => {
  return (
    <PageContainer header={{ title: '网络训练' }}>
      <ProCard>
        ...
        >
          ...
          <StepsForm.StepForm name="basic-options" title="基础内容">
            <ProFormSelect
              label="数据集"
              name="dataset"
              options={[{ value: 1, label: 'VOC12' }]}
              rules={[{ required: true }]}
            />
            <ProFormSelect
              label="网络"
         ...
         learning_rate: number
          ...
          <StepsForm.StepForm name="net_parameter" title="网络参数">
            <ProFormText
              name="name"
              label="训练标题"
